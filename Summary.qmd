...
\colorbox{ohdsiblue}{
  \makebox[\textwidth][l]{
    \textcolor{white}{\textbf{How Often?} (Incidence Rates from Target in PS-matched cohorts)}
  }
}
...
\colorbox{ohdsiblue}{
  \makebox[\textwidth][l]{
    \textcolor{white}{\textbf{How Reliable Are the Effect Estimates?}  (Objective Diagnostics from PS Matching)}
  }
}
...
\colorbox{ohdsiblue}{
  \makebox[\textwidth][l]{
    \textcolor{white}{\textbf{What have we learned from the OHDSI Network?}  (composite estimates)}
  }
}
